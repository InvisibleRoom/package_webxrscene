...
var CustomTrackballControls = function (object, domElement) {
	...
	this.dynamicDampingFactor = 0.09;
	...
	this.rotateCamera = (function () {
		...
		return function rotateCamera() {
			...
			if (angle) {
				...
				objectUpDirection.copy(new Vector3(0, 1, 0)).normalize();
	...
	function keydown(event) {
		...
		if (typeof event.target.classList != "undefined" && event.target.classList.contains("no-prevention")) {
			return;
		}
