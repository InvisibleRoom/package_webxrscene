...
class Controls {
  constructor(context) {
    ...
    this.SetupAR = this.SetupAR.bind(this);
       ...
       //DEBUG!!
       this.SetStaticDesktopPositionRotation({ x: 0, y: 2.7, z: 23 }, { x: 0, y: 0, z: 0 })
  ...
  SetStaticDesktopPositionRotation(pos, rot) {
    console.log("SETUP DESKTOP")
    this.context.Camera.instance.position.set(pos.x, pos.y, pos.z);
    this[this.currentControls].SetTarget(rot.x, rot.y, rot.z);
  }
